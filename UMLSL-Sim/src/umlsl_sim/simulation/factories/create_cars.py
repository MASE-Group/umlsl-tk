...
from umlsl_sim.constants import BLOCK_SIZE, CROSSING_MAX_SPEED, LANE_MAX_SPEED, MINIMAL_SPEED
...
from umlsl_sim.gui.car_colors import selected_colors
from umlsl_sim.scenario_io.car_spec import CarSpec, resolve_position
